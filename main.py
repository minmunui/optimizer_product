...
sol_scip_cost, total_cost, total_value = (
    scip.solve_cost_constraint(problem, cost_constraint=40_000, value_weights=None))
print(f"Selected: {sol_scip_cost}")
print(f"Total Cost: {total_cost}")
print(f"Value : {total_value}")

sol_scip_reliability, total_cost, total_value = (
    scip.solve_reliability_constraint(problem, reliability_constraint=[0.2, 2000, 44500]))
print(f"Selected: {sol_scip_reliability}")
print(f"Total Cost: {total_cost}")
print(f"Value : {total_value}")

sol_cpsat_cost, total_cost, total_value = (
    cpsat.solve_cost_constraint(problem, cost_constraint=40_000, value_weights=None))
print(f"Selected: {sol_cpsat_cost}")
print(f"Total Cost: {total_cost}")
print(f"Value : {total_value}")

sol_cpsat_reliability, total_cost, total_value = (
    cpsat.solve_reliability_constraint(problem, reliability_constraint=[0.2, 2000, 44500]))
